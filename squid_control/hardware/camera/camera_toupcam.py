...
import squid_control.hardware.camera.toupcam as toupcam
from squid_control.hardware.camera.toupcam_exceptions import hresult_checker
...
class Camera_Simulation(object):
    ...
    def __init__(self, rotate_image_angle=None, flip_image=None, zarr_dataset_path=None):
        ...
        from squid_control.hardware.camera.camera_default import Camera_Simulation as DefaultSimulation
