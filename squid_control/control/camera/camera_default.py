...
class Camera_Simulation(object):
    ...
    ZARR_DATASET_PATH = "/mnt/shared_documents/20251215-illumination-calibrated/data.zarr" #"https://hypha.aicell.io/agent-lens/apps/agent-lens/example-image-data.zarr"
